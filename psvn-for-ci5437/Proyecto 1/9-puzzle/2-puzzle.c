...
static const char *fwd_rule_name[ 8 ] = { "MOVE00_RIGHT", "MOVE01_RIGHT", "MOVE00_DOWN", "MOVE01_DOWN", "MOVE00_LEFT", "MOVE01_LEFT", "MOVE00_UP", "MOVE01_UP" };
#define get_fwd_rule_label( ruleid ) (fwd_rule_name[(ruleid)]) 
static const char *bwd_rule_name[ 8 ] = { "MOVE00_RIGHT", "MOVE01_RIGHT", "MOVE00_DOWN", "MOVE01_DOWN", "MOVE00_LEFT", "MOVE01_LEFT", "MOVE00_UP", "MOVE01_UP" };
...
static int bwd_prune_table[ 72 ] = { 8, 16, 24, 32, 40, 48, 56, 64, 0, 16, 0, 32, 0, 48, 56, 0, 0, 0, 24, 0, 40, 0, 0, 64, 0, 16, 0, 32, 40, 0, 0, 64, 8, 0, 0, 0, 0, 48, 56, 0, 0, 0, 24, 0, 0, 48, 0, 64, 0, 0, 0, 32, 0, 0, 56, 0, 8, 0, 0, 0, 0, 48, 0, 64, 0, 16, 0, 0, 40, 0, 0, 0 };
